...
bool PoweringTests()
{
	Test t("Powering Tests");
	t.VerifyTrue(fastpower(2,10,1023)==1,"Value should be 1");
	t.VerifyTrue(fastpower(5,4,626)==625,"Value should be 625");
	t.VerifyTrue(fastpower(5,0,1)==1,"Value should be 1");
	return t.isPassed();
}
...
bool HashingTests()
{
	...
	t.VerifyTrue(getHashKey("a",10001)==2,"Value for a should be 1");
	t.VerifyTrue(getHashKey("ab",10001)==121,"Value for ab should be 121");
	t.VerifyTrue(getHashKey("ba",10001)==49,"Value for ba should be 49");
...
bool HashTableTests()
{
	...
	t.VerifyTrue((h1->Find("a")==2),"a is at 1");
	t.VerifyTrue((h1->Find("ab")==121),"Position for ab should be 121");
...
bool HashInsertTests()
{
	...
	// cout <<inserted1<<endl;
	t.VerifyTrue(inserted1==1,"Position inserted should be 1");
