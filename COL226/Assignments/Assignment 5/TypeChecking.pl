...
hastype(Gamma,A+B,T):-hastype(Gamma,A,bool),hastype(Gamma,B,bool),T=bool.
hastype(Gamma,A+B,string):-hastype(Gamma,A,string),hastype(Gamma,B,string).
...
typeelab(Gamma,D1;D2,T):-append(L1,L2,T),typeelab(Gamma,D1,L1),append(Gamma,L1,GammaX),typeelab(GammaX,D2,L2).
typeelab(Gamma,D1||D2,T):-typeelab(Gamma,D1,L1),typeelab(Gamma,D2,L2),append(L1,L2,T).
