...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\015\000\003\003\003\003\003\
...
{fin = [], trans = 1},
{fin = [(N 23)], trans = 0},
{fin = [(N 17),(N 23)], trans = 4},
{fin = [(N 17)], trans = 4},
{fin = [(N 5),(N 23)], trans = 0},
{fin = [(N 10),(N 23)], trans = 7},
{fin = [(N 10)], trans = 7},
{fin = [(N 3),(N 23)], trans = 0},
{fin = [(N 19),(N 23)], trans = 0},
{fin = [(N 14),(N 23)], trans = 0},
{fin = [(N 21),(N 23)], trans = 0},
{fin = [(N 12),(N 23)], trans = 0},
{fin = [(N 7),(N 23)], trans = 0},
{fin = [(N 1),(N 23)], trans = 0}])
end
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => (lex())
| 10 => let val yytext=yymktext() in NUM (revfold (fn(a,r)=>ord(a)-ord(#"0")+10*r) (explode yytext) 0) end
| 12 => (RPAREN)
| 14 => (PLUS)
| 17 => let val yytext=yymktext() in if yytext="print" then PRINT else ID yytext end
| 19 => (SUB)
| 21 => (TIMES)
| 23 => let val yytext=yymktext() in error ("calc: ignoring bad character " ^yytext); lex() end
| 3 => (DIV)
| 5 => (EOS)
| 7 => (LPAREN)
